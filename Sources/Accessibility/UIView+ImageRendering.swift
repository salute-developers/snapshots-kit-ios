...
extension UIView {
    ...
    private func monochromeSnapshot(for snapshot: UIImage) throws -> UIImage? {
        if ProcessInfo().operatingSystemVersion.majorVersion == 13 {
            ...
            let maximumSize = CGSize(width: 1_365, height: 1_365)
    ...
    private func drawTiledHierarchySnapshots(in _: UIGraphicsImageRendererContext, error: inout Error?) {
    ...
    private static let tileSideLength: CGFloat = 2_000
